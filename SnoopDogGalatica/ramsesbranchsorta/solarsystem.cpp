...
char * modelFile [nModels] = {"Ruber.tri", "Primus.tri", "Duo.tri", "Secundus.tri", "Unum.tri", "WarBird.tri", "Missle.tri"};
...
void keyboard(unsigned char key, int x, int y) {
    ...
    case 'r' : case 'R' :  // bottom view
        viewMatrix = glm::lookAt(
          glm::vec3(1000.0f, 0.0f, 0.0f),  // eye is 1000 right from origin
          glm::vec3(   0.0f, 0.0f, 0.0f),   // looking at origin
          glm::vec3(   0.0f, 1.0f, 0.0f));   // camera'a up vector
    ...
    case 'i':
      viewMatrix = glm::lookAt(
        glm::vec3(0.0f, 10000.0f,  0.0f),   // eye is 3000 up from origin
        glm::vec3(0.0f,    0.0f,  0.0f),   // looking at origin  
        glm::vec3(0.0f,    0.0f, -1.0f));   // camera's up is looking towards -Z vector
        //strcpy(viewStr, " top view"); 
        break;
